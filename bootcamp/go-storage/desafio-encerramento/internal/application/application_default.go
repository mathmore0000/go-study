...
func (a *ApplicationDefault) SetUp() (err error) {
	...
	a.router.Route("/customers", func(r chi.Router) {
		// - GET /customers/condition-total
		r.Get("/condition-total", hdCustomer.GetTotalGroupedByCondition())
		// - GET /customers/top-5-spent-most
		r.Get("/top-5-spent-most", hdCustomer.GetTop5SpentMost())
		// - GET /customers
	...
	a.router.Route("/products", func(r chi.Router) {
		// - GET /top-5-most-sold
		r.Get("/top-5-most-sold", hdProduct.GetTop5MostSold())
		// - GET /products
	...
	a.router.Route("/invoices", func(r chi.Router) {
		// - POST /invoices/update-total
		r.Post("/update-total", hdInvoice.UpdateTotal())
		// - GET /invoices
